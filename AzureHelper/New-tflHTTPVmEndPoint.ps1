...
# Here is some sample code, commented out showing how to use this function.
...
# 
# 2 Remove it after testing
# Get-AzureVM -ServiceName $servicename -Name $VmName | Remove-AzureEndpoint -name 'HTTP' | Update-AzureVM
